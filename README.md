...
## II. Kiến trúc & Luồng dữ liệu (System Architecture) 

Hệ thống hoạt động theo mô hình: **Input**  **Processing**  **Storage**  **Output**.
...
## VI. Hướng dẫn kỹ thuật chi tiết (Technical Implementation Guide) 
...
**Luồng dữ liệu:** `View` `ViewModel`  `Repository` `Data Source`.
